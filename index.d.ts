...
export declare enum PrinterStatus {
    PRINTER_NORMAL = 0,
    PRINTER_PAPERLESS = 1,
    PRINTER_THP_HIGH_TEMPERATURE = 2,
    PRINTER_MOTOR_HIGH_TEMPERATURE = 3,
    PRINTER_IS_BUSY = 4,
    PRINTER_ERROR_UNKNOWN = 5
}
export declare class IposPrinterOriginal extends AwesomeCordovaNativePlugin {
    /**
...
export declare const IposPrinter: IposPrinterOriginal;